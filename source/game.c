...
void game(int position1, int position2, int color1, int color2, int match)
{
	...
	if (match != 0)
	{
		...
		{
		case 1:
			fp = fopen("c:\\mycode\\result\\result1.txt", "w");
			break;
		case 2:
			fp = fopen("c:\\mycode\\result\\result2.txt", "w");
			break;
		case 3:
			fp = fopen("c:\\mycode\\result\\result3.txt", "w");
			break;
		case 4:
			fp = fopen("c:\\mycode\\result\\result4.txt", "w");
			break;
		case 5:
			fp = fopen("c:\\mycode\\result\\result5.txt", "w");
			break;
		case 6:
			fp = fopen("c:\\mycode\\result\\result6.txt", "w");
			break;
		case 7:
			fp = fopen("c:\\mycode\\result\\result7.txt", "w");
			break;
		case 8:
			fp = fopen("c:\\mycode\\result\\result8.txt", "w");
			break;
		case 9:
			fp = fopen("c:\\mycode\\result\\result9.txt", "w");
			break;
		case 10:
			fp = fopen("c:\\mycode\\result\\result10.txt", "w");
			break;
		case 11:
			fp = fopen("c:\\mycode\\result\\result11.txt", "w");
			break;
		case 12:
			fp = fopen("c:\\mycode\\result\\result12.txt", "w");
			break;
		case 13:
			fp = fopen("c:\\mycode\\result\\result13.txt", "w");
			break;
		case 14:
			fp = fopen("c:\\mycode\\result\\result14.txt", "w");
			break;
		case 15:
			fp = fopen("c:\\mycode\\result\\result15.txt", "w");
			break;
		case 16:
			fp = fopen("c:\\mycode\\result\\result16.txt", "w");
			break;
		case 17:
			fp = fopen("c:\\mycode\\result\\result17.txt", "w");
			break;
		case 18:
			fp = fopen("c:\\mycode\\result\\result18.txt", "w");
			break;
		case 19:
			fp = fopen("c:\\mycode\\result\\result19.txt", "w");
			break;
		case 0:
			fp = fopen("c:\\mycode\\result\\result20.txt", "w");
			break;
		}
		if (fp == NULL)
		{
...
void DribbleEnter(_team *pmyteam, _team *popteam, _player *pplayer, _ball *pball)
{
	...
	if (pplayer->name == Computer)
	{
		...
		{
		case (0):
			arrive(pplayer, x[0], y[0]);

			break;
		case (1):
			arrive(pplayer, x[1], y[1]);

			break;
		case (2):
			arrive(pplayer, x[2], y[2]);

			break;
		case (3):
			arrive(pplayer, x[3], y[3]);
	...
	if (pmyteam->position == Left)
	{
		if (pplayer->name == Player)
		{
			...
			if (pmyteam->pnowstate == &pmyteam->Attack)
			{
				...
				{
				case (0):
					arrive(pplayer, 180.0, 290.0);
					break;
				case (1):
					arrive(pplayer, 320.0, 400.0);
					break;
				case (2):
					arrive(pplayer, 500.0, 160.0);
					break;
				case (3):
					arrive(pplayer, 400.0, 280.0);
					break;
				}
			}
			else if (pmyteam->pnowstate == &pmyteam->Defend)
			{
				...
				{
				case (0):
					arrive(pplayer, 100.0, 160.0);
					break;
				case (1):
					arrive(pplayer, 100.0, 400.0);
					break;
				case (2):
					arrive(pplayer, 200.0, 290.0);
					break;
				case (3):
					arrive(pplayer, 400.0, 290.0);
					break;
				}
			}
		}
		else
		{
			if (popteam->pnowstate == &popteam->Attack)
			{
				...
				{
				case (0):
					arrive(pplayer, 500.0, 290.0);
					break;
				case (1):
					arrive(pplayer, 320.0, 290.0);
					break;
				case (2):
					arrive(pplayer, 160.0, 160.0);
					break;
				case (3):
					arrive(pplayer, 160.0, 400.0);
					break;
				}
			}
			else if (popteam->pnowstate == &popteam->Defend)
			{
				...
				{
				case (0):
					arrive(pplayer, 540.0, 160.0);
					break;
				case (1):
					arrive(pplayer, 540.0, 400.0);
					break;
				case (2):
					arrive(pplayer, 440.0, 280.0);
					break;
				}
			}
		}
	...
	else
	{
		if (pplayer->name == Player)
		{
			...
			if (pmyteam->pnowstate == &pmyteam->Attack)
			{
				...
				{
				case (0):
					arrive(pplayer, 460.0, 290.0);
					break;
				case (1):
					arrive(pplayer, 320.0, 400.0);
					break;
				case (2):
					arrive(pplayer, 140.0, 160.0);
					break;
				case (3):
					arrive(pplayer, 240.0, 280.0);
					break;
				}
			}
			else if (pmyteam->pnowstate == &pmyteam->Defend)
			{
				...
				case (1):
					...
					break;
				case (2):
					arrive(pplayer, 440.0, 290.0);
					break;
				case (3):
					arrive(pplayer, 240.0, 290.0);
					break;
				}
			}
		}
		else
		{
			if (popteam->pnowstate == &popteam->Attack)
			{
				...
				{
				case (0):
					arrive(pplayer, 140.0, 290.0);
					break;
				case (1):
					arrive(pplayer, 320.0, 290.0);
					break;
				case (2):
					arrive(pplayer, 480.0, 160.0);
					break;
				case (3):
					arrive(pplayer, 480.0, 400.0);
					break;
				}
			}
			else if (popteam->pnowstate == &popteam->Defend)
	...
	if (pmyteam->position == Left)
	{
		if (pplayer->name == Player)
		{
			...
			else if (pmyteam->pnowstate == &pmyteam->Defend)
			{
				...
				{
				case (0):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 100.0, 160.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (1):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 100.0, 400.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (2):
	...
	else
	{
		if (pplayer->name == Player)
		{
			if (pmyteam->pnowstate == &pmyteam->Attack)
			{
				...
				{
				case (0):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 460.0, 290.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (1):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 320.0, 400.0) < 5.0)
					...
					break;
				case (2):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 140.0, 160.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (3):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 240.0, 280.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				}
			}
			else if (pmyteam->pnowstate == &pmyteam->Defend)
			{
				...
				case (1):
					...
					break;
				case (2):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 440.0, 290.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (3):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 240.0, 290.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				}
			}
		...
		else
		{
			if (popteam->pnowstate == &popteam->Attack)
			{
				...
				{
				case (0):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 140.0, 290.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (1):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 320.0, 290.0) < 5.0)
					...
					break;
				case (2):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 480.0, 160.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (3):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 480.0, 400.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				}
			}
			else if (popteam->pnowstate == &popteam->Defend)
			{
				...
				case (1):
					...
					break;
				case (2):
					if (distance(pplayer->now_pos.x, pplayer->now_pos.y, 200.0, 280.0) < 5.0)
						PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
					break;
				case (3):
					PlayerChangestate(pmyteam, popteam, pplayer, pball, &pplayer->Actioning);
...
void playerPower(_team *pteam)
{
	...
	if (pteam->name == Player)
	{
		...
		case 1:
			...
			break;
		case 2:
			fpplayer = fopen("c:\\mycode\\shop\\2.txt", "r");
			break;
		case 3:
			fpplayer = fopen("c:\\mycode\\shop\\3.txt", "r");
			break;
		case 4:
			fpplayer = fopen("c:\\mycode\\shop\\4.txt", "r");
			break;
		case 5:
			fpplayer = fopen("c:\\mycode\\shop\\5.txt", "r");
			break;
		}
		if (fpplayer == NULL)
		{
